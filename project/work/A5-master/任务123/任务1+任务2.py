...
################################## 数据读取与预处理 ################################
df = pd.read_excel("E:/桌面/大学实践数据/中软实习/工作记录/A5-master/任务123/cph.xlsx")
...
####################################### 任务1 ######################################
with open('E:/桌面/大学实践数据/中软实习/工作记录/A5-master/任务123/居民客户的用电缴费习惯分析1.csv', mode='w', encoding='gbk', newline='') as f:
...
####################################### 任务2 #######################################
with open('E:/桌面/大学实践数据/中软实习/工作记录/A5-master/任务123/居民客户的用电缴费习惯分析2.csv', mode='w', encoding='gbk', newline='') as f:
    csvwriter = csv.writer(f)
