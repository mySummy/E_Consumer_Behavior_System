...
def Get_k_means(data,num):
    ...
    path_data="E:/桌面/大学实践数据/中软实习/工作记录/A5-master/任务4/save/data3"+str(num)+'/'
    os.mkdir(path_data)
    pd.DataFrame(cluster1).to_pickle(path_data + "E:/桌面/大学实践数据/中软实习/工作记录/A5-master/任务4/save/data3/cluseter1.pkl")
    pd.DataFrame(cluster2).to_pickle(path_data + "E:/桌面/大学实践数据/中软实习/工作记录/A5-master/任务4/save/data3/cluseter2.pkl")
    pd.DataFrame(cluster3).to_pickle(path_data + "E:/桌面/大学实践数据/中软实习/工作记录/A5-master/任务4/save/data3/cluseter3.pkl")
